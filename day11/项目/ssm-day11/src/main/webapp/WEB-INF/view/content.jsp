...
<body class="gray-bg">
	    		...
	    		var myEcharts = echarts.init(document.getElementById("main"))
	    			...
	    			$.ajax({
	    			    ...
	    			    success:function(res){
	    			    	...
	    			    	if(res.success){
	    			    		res.alist.forEach(function(content){
		    			    		xdata.push(content.oname);
		    			    		ydata.push({value:content.num,name:content.oname})
	...
	function initEditUser(getSelection){
		...
		$('#createtime').val(new Date(getSelection.createtime));
	}
