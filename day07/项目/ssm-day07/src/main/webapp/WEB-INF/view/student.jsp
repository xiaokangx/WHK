...
<body class="gray-bg">
		...
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-body">
					<form id="form_user" method="post" action="reserveStudent.htm" enctype="multpart/from-data">
						...
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							...
							<tr>
								<td>班主任：</td>
								<td colspan="4">
									<select class="form-control" name="mzrid" id = "mzrid" aria-required="true" required>
	           ...
	           // height: 500,                        //行高，如果没有设置height属性，表格自动根据记录条数觉得表格高度
	            ...
	            },
	            {
	                ...
	                formatter:function(value,row,index){
	                	return "<img  src='/img/"+value+"' width='30px' height='30px'>";
	                }
	            },
	            {
	                field: 'endtime',
	    			...
	    			$.ajax({
		    		    ...
		    		    success:function(res){
		    		    	...
		    		    	if(res.success){
		    		    		...
		    		    		//循环后台设置到前台的值
			    		    	res.slist.forEach(function(student){
	...
	function initEditUser(getSelection){
		...
		$('#endtime').val(new Date(getSelection.endtime).Format("yyyy-MM-dd"));
		$('#mzrid').val(getSelection.mzrid);
