...
<body class="gray-bg">
				...
				<div class="modal-body">
					<form id="form_user" method="post" action="reservePerson.htm">
						...
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							...
							<tr>
								<td>存款人爱好：</td>
								<td><input type="checkbox" id="pLike1" name="pLike"
									...
									value="美女" aria-required="true" required/>美女
								</td>
								<td>&nbsp;&nbsp;</td>
								<td>存款人性别：</td>
								<td><input type="radio" id="pSex" name="pSex"
							...
							<tr>
								...
								<td>存款日期：</td>
								<td>
									<input id="createtime123" name="createtime" 
	...
	<!-- 新增和修改对话框 -->
	<div class="modal fade" id="modal_addBank" role="dialog" aria-labelledby="modal_addBank" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-body">
					<form id="form_addBank" method="post" action="addBank.htm">
						...
						<div class="modal-footer">
							<button type="button" class="btn btn-primary"  id="submit_form_addBank">保存</button>
							<button type="button" class="btn btn-default" data-dismiss="modal">关闭</button>
						</div>
					</form>
	...
	$(function () {
	    ...
	    $("#submit_form_addBank").click(function(){
	    	$("#form_addBank").submit();
	...
	var ButtonInit = function () {
	    ...
	    oInit.Init = function () {
	    	...
	    	$("#btn_addBank").click(function(){
	    			$('#modal_addBank').modal({backdrop: 'static', keyboard: false});
	    			$("#modal_addBank").show();
	        });
	    	//导出弹框
	    	...
	    	$("#btn_echarts").click(function(){
    			...
    			$.ajax({
    			    ...
    			    success:function(res){
    			    	...
    			    	ydata = new Array();
    			    	if(res.success){
    			    	res.elist.forEach(function(jiyunPerson){
    			    		xdata.push(jiyunPerson.bname);
    			    		ydata.push({value:jiyunPerson.num,name:jiyunPerson.bname});
    			    	});
    			    	option = {
    			    		    title: {
    			    		        text: '某站点用户访问来源',
	...
	function initEditUser(getSelection){
		...
		$('#createtime123').val(new Date(getSelection.createtime).Format("yyyy-MM-dd"));
