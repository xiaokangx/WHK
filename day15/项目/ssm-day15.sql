/*
 ...
 Source Schema         : ssm-17

 Target Server Type    : MySQL
 Target Server Version : 50527
 File Encoding         : 65001

 Date: 17/08/2020 20:47:08
*/
...
-- ----------------------------
-- Table structure for jiyun_bank
-- ----------------------------
DROP TABLE IF EXISTS `jiyun_bank`;
CREATE TABLE `jiyun_bank`  (
...
-- ----------------------------
-- Records of jiyun_bank
-- ----------------------------
INSERT INTO `jiyun_bank` VALUES (1, '中国银行', NULL);
INSERT INTO `jiyun_bank` VALUES (2, '建设银行', NULL);
INSERT INTO `jiyun_bank` VALUES (3, '工商银行', NULL);
INSERT INTO `jiyun_bank` VALUES (15, '邮政银行', NULL);
INSERT INTO `jiyun_bank` VALUES (21, '民生银行', NULL);

-- ----------------------------
-- Table structure for jiyun_person
-- ----------------------------
DROP TABLE IF EXISTS `jiyun_person`;
CREATE TABLE `jiyun_person`  (
  ...
  `p_sex` varchar(30) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `createtime` date NULL DEFAULT NULL,
  `p_like` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `p_count` int(100) NULL DEFAULT NULL,
  PRIMARY KEY (`p_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 4 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Compact;

-- ----------------------------
-- Records of jiyun_person
-- ----------------------------
INSERT INTO `jiyun_person` VALUES (1, 2, 'qqq', 111, '女', '2020-08-06', '名表', 20);
INSERT INTO `jiyun_person` VALUES (2, 1, 'qgfde', 489, '女', '2020-08-19', '美女', 85);
INSERT INTO `jiyun_person` VALUES (3, 2, 'zetxcvu', 8451, '女', '2020-08-17', '名表', 8741215);
...
INSERT INTO `log` VALUES (3, 'admin', '2020-08-17 14:11:22', NULL, '登录', '0:0:0:0:0:0:0:1', NULL);
INSERT INTO `log` VALUES (4, 'admin', '2020-08-17 14:17:15', NULL, '退出', NULL, NULL);
INSERT INTO `log` VALUES (5, 'admin', '2020-08-17 14:17:16', NULL, '登录', '0:0:0:0:0:0:0:1', NULL);
INSERT INTO `log` VALUES (6, 'admin', '2020-08-17 14:17:28', NULL, '退出', NULL, NULL);
INSERT INTO `log` VALUES (7, 'admin', '2020-08-17 14:17:29', NULL, '登录', '0:0:0:0:0:0:0:1', NULL);
INSERT INTO `log` VALUES (8, 'admin', '2020-08-17 15:06:58', NULL, '登录', '0:0:0:0:0:0:0:1', NULL);
INSERT INTO `log` VALUES (9, 'admin', '2020-08-17 15:23:44', NULL, '登录', '0:0:0:0:0:0:0:1', NULL);
INSERT INTO `log` VALUES (10, 'admin', '2020-08-17 15:52:16', NULL, '登录', '0:0:0:0:0:0:0:1', NULL);
INSERT INTO `log` VALUES (11, 'admin', '2020-08-17 16:15:10', NULL, '登录', '0:0:0:0:0:0:0:1', NULL);
INSERT INTO `log` VALUES (12, 'admin', '2020-08-17 16:18:18', NULL, '登录', '0:0:0:0:0:0:0:1', NULL);
INSERT INTO `log` VALUES (13, 'admin', '2020-08-17 16:40:42', NULL, '登录', '0:0:0:0:0:0:0:1', NULL);
INSERT INTO `log` VALUES (14, 'admin', '2020-08-17 16:45:22', NULL, '退出', NULL, NULL);
INSERT INTO `log` VALUES (15, 'admin', '2020-08-17 16:45:23', NULL, '登录', '0:0:0:0:0:0:0:1', NULL);
INSERT INTO `log` VALUES (16, 'admin', '2020-08-17 16:54:02', NULL, '登录', '0:0:0:0:0:0:0:1', NULL);
INSERT INTO `log` VALUES (17, 'admin', '2020-08-17 17:17:22', NULL, '登录', '0:0:0:0:0:0:0:1', NULL);
INSERT INTO `log` VALUES (18, 'admin', '2020-08-17 17:37:18', NULL, '登录', '0:0:0:0:0:0:0:1', NULL);
INSERT INTO `log` VALUES (19, 'admin', '2020-08-17 19:00:02', NULL, '登录', '0:0:0:0:0:0:0:1', NULL);
INSERT INTO `log` VALUES (20, 'admin', '2020-08-17 19:07:41', NULL, '登录', '0:0:0:0:0:0:0:1', NULL);
INSERT INTO `log` VALUES (21, 'admin', '2020-08-17 19:13:14', NULL, '登录', '0:0:0:0:0:0:0:1', NULL);
INSERT INTO `log` VALUES (22, 'admin', '2020-08-17 19:14:52', NULL, '登录', '0:0:0:0:0:0:0:1', NULL);
INSERT INTO `log` VALUES (23, 'admin', '2020-08-17 19:16:54', NULL, '登录', '0:0:0:0:0:0:0:1', NULL);
INSERT INTO `log` VALUES (24, 'admin', '2020-08-17 19:18:46', NULL, '登录', '0:0:0:0:0:0:0:1', NULL);
INSERT INTO `log` VALUES (25, 'admin', '2020-08-17 19:41:40', NULL, '登录', '0:0:0:0:0:0:0:1', NULL);
INSERT INTO `log` VALUES (26, 'admin', '2020-08-17 20:37:16', NULL, '登录', '0:0:0:0:0:0:0:1', NULL);
...
INSERT INTO `menu` VALUES (9, '存款管理', '', 1, '', 'isParent', '', 6);
INSERT INTO `menu` VALUES (10, '存款管理', 'person/personIndex.htm', 9, '', NULL, '', 7);
...
INSERT INTO `operation` VALUES (10015, '添加', 10, '存款管理', 'btn_add', '');
INSERT INTO `operation` VALUES (10016, '修改', 10, '存款管理', 'btn_edit', '');
INSERT INTO `operation` VALUES (10017, '删除', 10, '存款管理', 'btn_delete', '');
INSERT INTO `operation` VALUES (10018, '导出', 10, '存款管理', 'btn_export', '');
INSERT INTO `operation` VALUES (10019, '报表', 10, '存款管理', 'btn_echarts', '');
INSERT INTO `operation` VALUES (10020, '添加银行', 10, '存款管理', 'btn_addBank', '');
