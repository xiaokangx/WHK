					...
					<form id="form_user" method="post" action="reserveStudent.htm">
						...
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							...
							<tr>
								...
								<td>&nbsp;&nbsp;</td>
								<td>所属年级：</td>
								<td><select class="form-control" name="teacherid" id = "teacherid" aria-required="true" required>
							...
							<tr>
								...
								<td>&nbsp;&nbsp;</td>
								<td>入校时间：</td>
								<td><input  id="txt_search_start" name="entrytime" class="laydate-icon form-control layer-date"/></td>
							</tr>
