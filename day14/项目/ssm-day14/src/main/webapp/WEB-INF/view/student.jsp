...
<body class="gray-bg">
        ...
        <div class="row">
			 ...
			 <div class="form-horizontal m-t">			  
			  <div class="form-group col-lg-7">
                 <label class="col-sm-2 control-label">入校时间时间</label>
                 <div class="col-sm-8">
					...
					<form id="form_user" method="post" action="reserveStudent.htm">
						...
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							...
							<tr>
								...
								<td>入校时间：</td>
								<td>
								     <input  readonly="readonly" id="entrytime" name="entrytime" class="laydate-icon form-control layer-date"/>
								</td>
							</tr>
	...
	<div class="modal fade" id="modal_user_teacher" role="dialog" aria-labelledby="modal_user_teacher" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-body">
					<form id="form_addTeacher" method="post" action="addTeacher.htm">
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							<tr>
								<td>教师姓名：</td>
								<td><input type="text" id="name" name="name"
							...
							<tr>
								<td>入校时间：</td>
								<td>
								     <input readonly="readonly" id="entrytime2" name="entrytime" class="laydate-icon form-control layer-date"/>
								</td>
							</tr>
						...
						<div class="modal-footer">
							<button type="button" class="btn btn-primary"  id="submit_form_addTeacher">保存</button>
							<button type="button" class="btn btn-default" data-dismiss="modal">关闭</button>
						</div>
					</form>
	...
	$(function () {
	    ...
	    $("#submit_form_addTeacher").click(function(){
	    			...
	    			$.ajax({
	    			    ...
	    			    success:function(res){
	    			    	...
	    			    	if(res.success){
	    			    		...
	    			    		res.slist.forEach(function(studentVo){
	    			    			xdata.push(studentVo.tname);
	    			    			ydata.push({value:studentVo.num,name:studentVo.tname});
	    			    		});
