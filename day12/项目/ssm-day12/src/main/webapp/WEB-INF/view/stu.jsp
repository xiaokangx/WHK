...
<body class="gray-bg">
					...
					<form id="form_user" method="post" action="reserveStu.htm">
						...
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							<tr>
								...
								<td>学生生日：</td>
								<td>
								   <input id="sdbirth" name="sdbirth" class="laydate-icon form-control layer-date"/>
								</td>
							</tr>
							...
							<tr>
								...
								<td>&nbsp;&nbsp;</td>
								<td>学生爱好：</td>
								<td><input type="checkbox" id="sdhobby1" name="sdhobby"
			...
			<div class="modal-content">
				<div class="modal-body">
					<form id="form_major" method="post" action="addmajor.htm">
						...
						<div class="modal-footer">
							<button type="button" class="btn btn-primary"  id="submit_form_major">保存</button>
							<button type="button" class="btn btn-default" data-dismiss="modal">关闭</button>
						</div>
					</form>
	...
	<div class="modal fade" id="modal_user_export" role="dialog" aria-labelledby="modal_user_export" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-footer">
				<button type="button" class="btn btn-danger"  id="export_stu">导出</button>
				<button type="button" class="btn btn-default" data-dismiss="modal">取消</button>
			</div>
			</div>
		</div>
	...
	$(function () {
	    ...
	    $("#submit_form_major").click(function(){
	    	$("#form_major").submit();
	    });
	    		...
	    		var myEcharts = echarts.init(document.getElementById("main"))
	    			...
	    			$.ajax({
	    			    ...
	    			    success:function(res){
	    			    	...
	    			    	var ydata = new Array();
	    			    	if(res.success){
	    		    	    res.slist.forEach(function(stuVo){
