...
<body class="gray-bg">
					...
					<form id="form_user" method="post" action="reserveStudent.htm">
						...
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							<tr>
								...
								<td>学生生日：</td>
								<td>
									<input readonly="readonly" id="birthday" name="birthday" class="laydate-icon form-control layer-date"/>
								</td>
							</tr>
	...
	<!--导出对话框 -->
	<div class="modal fade" id="modal_stu_export" role="dialog" aria-labelledby="modal_stu_export" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					 <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
				...
				<div class="modal-footer">
				<button type="button" class="btn btn-danger"  id="del_stu_export">导出</button>
				<button type="button" class="btn btn-default" data-dismiss="modal">取消</button>
			</div>
			</div>
		</div>
	...
	var ButtonInit = function () {
	    ...
	    oInit.Init = function () {
	    	...
	    	$("#btn_export").click(function(){
	    			$('#modal_stu_export').modal({backdrop: 'static', keyboard: false});
	    			$("#modal_stu_export").show();
	        });
	        
	    	$("#del_stu_export").click(function(){
	    		$.ajax({
	...
	function initEditUser(getSelection){
		...
		$("input[value="+getSelection.sex+"]").attr("checked",true);
