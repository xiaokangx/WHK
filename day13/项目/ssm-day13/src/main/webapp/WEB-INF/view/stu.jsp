...
<body class="gray-bg">
					...
					<form id="form_user" method="post" action="reserveStu.htm">
						...
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							<tr>
								...
								<td>&nbsp;&nbsp;</td>
								<td>学生性别：</td>
								<td><input type="radio" id="sSex" name="sSex"
							...
							<tr>
								...
								<td>学生生日：</td>
								<td>
								  <input id="sBirth" name="sBirth" class="laydate-icon form-control layer-date"/>
								</td>
							</tr>
							<tr>
								<td>专业：</td>
	...
	<!-- 添加专业 -->
	<div class="modal fade" id="modal_addMajor" role="dialog" aria-labelledby="modal_addMajor" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-body">
					<form id="form_addMajor" method="post" action="addMajor.htm">
						...
						<div class="modal-footer">
							<button type="button" class="btn btn-primary"  id="del_user_addMajor">保存</button>
							<button type="button" class="btn btn-default" data-dismiss="modal">关闭</button>
						</div>
					</form>
			...
			<div class="modal-content">
				...
				<div class="modal-body">
							<form id="form_import" action="importStu.htm" method="post" enctype="multipart/form-data">
							 <input type="file" name="importStu">
							</form>
				</div>
				<div class="modal-footer">
	...
	$(function () {
	    ...
	    var validator = $("#form_addMajor").validate({
    		submitHandler: function(form){
   		      $(form).ajaxSubmit({
   		    	dataType:"json",
   		    	success: function (data) {
	    ...
	    $("#del_user_addMajor").click(function(){
	...
	var ButtonInit = function () {
	    ...
	    oInit.Init = function () {
	    	...
	    	$("#btn_addMajor").click(function(){
	    			$('#modal_addMajor').modal({backdrop: 'static', keyboard: false});
	    			$("#modal_addMajor").show();
	        });
	    	//导入
	    		...
	    		var myEcharts = echarts.init(document.getElementById("main"));
	    			...
	    			$.ajax({
	    			    ...
	    			    success:function(res){
	    			    	...
	    			    	ydata = new Array();
	    			    	if(res.success){
	    		    		res.alist.forEach(function(stuVo){
	    		    			xdata.push(stuVo.mname);
	    		    			ydata.push({value:stuVo.num,name:stuVo.mname});
	    		    		});
	    		    		option = {
    			    			    xAxis: {
    			    			        type: 'category',
	...
	function initEditUser(getSelection){
		...
		$('#sHobby1').attr("checked",getSelection.sHobby.indexOf("篮球")!=-1);
		$('#sHobby2').attr("checked",getSelection.sHobby.indexOf("足球")!=-1);
		$('#sHobby3').attr("checked",getSelection.sHobby.indexOf("排球")!=-1);
