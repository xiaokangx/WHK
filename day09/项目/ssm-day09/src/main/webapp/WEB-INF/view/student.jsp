...
<body class="gray-bg">
					...
					<form id="form_user" method="post" action="reserveStudent.htm">
						...
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							...
							<tr>
								...
								<td>&nbsp;&nbsp;</td>
								<td>入校时间：</td>
								<td><input readonly="readonly" id="entrytime" name="entrytime" class="laydate-icon form-control layer-date"/></td>
							</tr>
						</table>
			...
			<div class="modal-content">
				<div class="modal-body">
					<form id="form_course" method="post" action="reserveCourse.htm">
						...
						<div class="modal-footer">
							<button type="button" class="btn btn-primary"  id="submit_form_course">保存</button>
							<button type="button" class="btn btn-default" data-dismiss="modal">关闭</button>
						</div>
					</form>
	...
	<div class="modal fade" id="modal_user_echarts" role="dialog" aria-labelledby="modal_user_echarts" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body" style="width: 500px;height: 300px" id="main">
	...
	<div class="modal fade" id="modal_user_import" role="dialog" aria-labelledby="modal_user_import" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-footer">
				<button type="button" class="btn btn-danger"  id="submit_form_import">导入</button>
				<button type="button" class="btn btn-default" data-dismiss="modal">取消</button>
			</div>
			</div>
		</div>
	...
	$(function () {
	    ...
	    $("#submit_form_course").click(function(){
	    	$("#form_course").submit();
	    });
