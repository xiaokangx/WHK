/*
 ...
 Source Schema         : ssm-day10

 Target Server Type    : MySQL
 Target Server Version : 50527
 File Encoding         : 65001

 Date: 11/08/2020 21:34:51
*/
...
-- Records of goods
-- ----------------------------
INSERT INTO `goods` VALUES (1, 1, 101, '锤子', 20, '上架', '2020-08-02');
INSERT INTO `goods` VALUES (2, 3, 102, '梨', 5, '上架', '2020-08-11');
INSERT INTO `goods` VALUES (3, 2, 103, '红衣服', 1000, '下架', '2020-08-31');
INSERT INTO `goods` VALUES (4, 2, 102, '香蕉夹', 5, '上架', '2020-08-11');
...
-- ----------------------------
INSERT INTO `goodstype` VALUES (1, '电子产品', NULL, NULL);
INSERT INTO `goodstype` VALUES (2, '服装鞋帽', NULL, NULL);
INSERT INTO `goodstype` VALUES (3, '水果蔬菜', NULL, NULL);
INSERT INTO `goodstype` VALUES (6, '家电', NULL, NULL);
INSERT INTO `goodstype` VALUES (7, '商品1', NULL, NULL);
INSERT INTO `goodstype` VALUES (8, '商品2', NULL, NULL);
INSERT INTO `goodstype` VALUES (9, '商品3', NULL, NULL);
INSERT INTO `goodstype` VALUES (10, '商品4', NULL, NULL);
...
) ENGINE = InnoDB AUTO_INCREMENT = 19 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '操作日志记录' ROW_FORMAT = Compact;
...
INSERT INTO `log` VALUES (3, 'admin', '2020-08-11 18:45:23', NULL, '登录', '0:0:0:0:0:0:0:1', NULL);
INSERT INTO `log` VALUES (4, 'admin', '2020-08-11 18:48:40', NULL, '退出', NULL, NULL);
INSERT INTO `log` VALUES (5, 'admin', '2020-08-11 18:48:49', NULL, '登录', '0:0:0:0:0:0:0:1', NULL);
INSERT INTO `log` VALUES (6, 'admin', '2020-08-11 19:25:34', NULL, '登录', '0:0:0:0:0:0:0:1', NULL);
INSERT INTO `log` VALUES (7, 'admin', '2020-08-11 20:31:45', NULL, '登录', '0:0:0:0:0:0:0:1', NULL);
INSERT INTO `log` VALUES (8, 'admin', '2020-08-11 20:34:11', NULL, '登录', '0:0:0:0:0:0:0:1', NULL);
INSERT INTO `log` VALUES (9, 'admin', '2020-08-11 20:43:04', NULL, '登录', '0:0:0:0:0:0:0:1', NULL);
INSERT INTO `log` VALUES (10, 'admin', '2020-08-11 20:51:33', NULL, '登录', '0:0:0:0:0:0:0:1', NULL);
INSERT INTO `log` VALUES (11, 'admin', '2020-08-11 21:03:18', NULL, '登录', '0:0:0:0:0:0:0:1', NULL);
INSERT INTO `log` VALUES (12, 'admin', '2020-08-11 21:12:51', NULL, '登录', '0:0:0:0:0:0:0:1', NULL);
INSERT INTO `log` VALUES (13, 'admin', '2020-08-11 21:12:53', 'intercept the method: com.xiaoshu.controller.GoodsController.indexcom.xiaoshu.entity.Goodstype cannot be cast to java.util.List', '拦截到异常', '0:0:0:0:0:0:0:1', '/ssm-day10');
INSERT INTO `log` VALUES (14, 'admin', '2020-08-11 21:13:48', 'intercept the method: com.xiaoshu.controller.GoodsController.indexcom.xiaoshu.entity.Goodstype cannot be cast to java.util.List', '拦截到异常', '0:0:0:0:0:0:0:1', '/ssm-day10');
INSERT INTO `log` VALUES (15, 'admin', '2020-08-11 21:15:37', NULL, '登录', '0:0:0:0:0:0:0:1', NULL);
INSERT INTO `log` VALUES (16, 'admin', '2020-08-11 21:16:01', 'intercept the method: com.xiaoshu.controller.GoodsController.indexcom.xiaoshu.entity.Goodstype cannot be cast to java.util.List', '拦截到异常', '0:0:0:0:0:0:0:1', '/ssm-day10');
INSERT INTO `log` VALUES (17, 'admin', '2020-08-11 21:18:10', 'intercept the method: com.xiaoshu.controller.GoodsController.indexcom.xiaoshu.entity.Goodstype cannot be cast to java.util.List', '拦截到异常', '0:0:0:0:0:0:0:1', '/ssm-day10');
INSERT INTO `log` VALUES (18, 'admin', '2020-08-11 21:21:33', NULL, '登录', '0:0:0:0:0:0:0:1', NULL);
...
INSERT INTO `menu` VALUES (9, '商品管理系统', '', 1, '', 'isParent', '', 6);
INSERT INTO `menu` VALUES (10, '商品信息', 'goods/goodsIndex.htm', 9, '', NULL, '', 7);
...
INSERT INTO `operation` VALUES (10015, '添加商品', 10, '商品信息', 'btn_add', '');
INSERT INTO `operation` VALUES (10016, '修改商品', 10, '商品信息', 'btn_edit', '');
INSERT INTO `operation` VALUES (10017, '添加商品分类', 10, '商品信息', 'btn_addtype', '');
INSERT INTO `operation` VALUES (10018, 'Echarts报表', 10, '商品信息', 'btn_echarts', '');
