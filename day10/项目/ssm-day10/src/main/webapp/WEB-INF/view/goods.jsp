...
<body class="gray-bg">
	...
	<div class="modal fade" id="modal_user_type" role="dialog" aria-labelledby="modal_user_type" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-body">
					<form id="form_typegoods" method="post" action="addtypeGoods.htm">
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							<tr>
								<td>添加分类：</td>
						...
						<div class="modal-footer">
							<button type="button" class="btn btn-primary"  id="submit_form_type">保存</button>
							<button type="button" class="btn btn-default" data-dismiss="modal">关闭</button>
						</div>
					</form>
	...
	$(function () {
	    ...
	    //分类验证
	    var validator = $("#form_typegoods").validate({
    		submitHandler: function(form){
   		      $(form).ajaxSubmit({
   		    	dataType:"json",
   		    	success: function (data) {
	    ...
	    $("#submit_form_type").click(function(){
	    	$("#form_typegoods").submit();
	    });
