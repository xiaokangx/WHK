...
<body class="gray-bg">
        ...
        <div class="row">
			 ...
			 <div class="form-horizontal m-t">			  
			  <div class="form-group col-lg-7">
                 <label class="col-sm-2 control-label">入职时间区间</label>
                 <div class="col-sm-8">
						...
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							...
							<tr>
								...
								<td><input type="checkbox" id="expressTrait1" name="expressTrait"
									value="勤劳" aria-required="true" required/>勤劳
									...
									value="帅气" aria-required="true" required/>帅气
									</td>
	...
	function initEditUser(getSelection){
		...
		$('#expressTrait2').attr("checked",getSelection.expressTrait.indexOf("认真")!=-1);
		$('#expressTrait3').attr("checked",getSelection.expressTrait.indexOf("帅气")!=-1);
