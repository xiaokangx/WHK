/*
 ...
 Source Schema         : ssm-zy

 Target Server Type    : MySQL
 Target Server Version : 50527
 File Encoding         : 65001

 Date: 02/08/2020 19:07:48
*/
...
CREATE TABLE `device`  (
  ...
  `deviceram` varchar(30) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
...
-- Records of device
-- ----------------------------
INSERT INTO `device` VALUES (1, 1, '手机', '8g', '红色', 5000, '启用', '2020-08-02');
INSERT INTO `device` VALUES (5, 3, 'rfg', '5g', 'esthg', 52, '启用', '2020-08-02');
INSERT INTO `device` VALUES (6, 2, 'afg', '785g', 'aeg', 572, '启用', '2020-08-02');
INSERT INTO `device` VALUES (7, 1, '小米', '8g', '白色', 3000, '禁用', '2020-08-02');
...
-- ----------------------------
INSERT INTO `devicetype` VALUES (1, '电子设备', NULL, NULL);
INSERT INTO `devicetype` VALUES (2, '建材设备', NULL, NULL);
INSERT INTO `devicetype` VALUES (3, '自动设备', NULL, NULL);
...
) ENGINE = InnoDB AUTO_INCREMENT = 13 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '操作日志记录' ROW_FORMAT = Compact;
...
INSERT INTO `log` VALUES (3, 'admin', '2020-08-02 10:47:33', NULL, '登录', '0:0:0:0:0:0:0:1', NULL);
INSERT INTO `log` VALUES (4, 'admin', '2020-08-02 10:47:34', NULL, '退出', NULL, NULL);
INSERT INTO `log` VALUES (5, 'admin', '2020-08-02 10:47:44', NULL, '登录', '0:0:0:0:0:0:0:1', NULL);
INSERT INTO `log` VALUES (6, 'admin', '2020-08-02 10:51:13', NULL, '退出', NULL, NULL);
INSERT INTO `log` VALUES (7, 'admin', '2020-08-02 10:51:22', NULL, '登录', '0:0:0:0:0:0:0:1', NULL);
INSERT INTO `log` VALUES (8, 'admin', '2020-08-02 11:30:39', NULL, '登录', '0:0:0:0:0:0:0:1', NULL);
INSERT INTO `log` VALUES (9, 'admin', '2020-08-02 13:49:17', NULL, '登录', '0:0:0:0:0:0:0:1', NULL);
INSERT INTO `log` VALUES (10, 'admin', '2020-08-02 14:50:48', NULL, '登录', '0:0:0:0:0:0:0:1', NULL);
INSERT INTO `log` VALUES (11, 'admin', '2020-08-02 15:07:15', NULL, '登录', '0:0:0:0:0:0:0:1', NULL);
INSERT INTO `log` VALUES (12, 'admin', '2020-08-02 17:08:55', NULL, '登录', '0:0:0:0:0:0:0:1', NULL);
...
INSERT INTO `menu` VALUES (9, '设备管理系统', '', 1, '', 'isParent', '', 6);
INSERT INTO `menu` VALUES (10, '设备信息', 'device/deviceIndex.htm', 9, '', NULL, '', 7);
...
INSERT INTO `operation` VALUES (10015, '添加', 10, '设备信息', 'btn_add', '');
INSERT INTO `operation` VALUES (10016, '删除', 10, '设备信息', 'btn_delete', '');
INSERT INTO `operation` VALUES (10017, '导出', 10, '设备信息', 'btn_export', '');
