...
<body class="gray-bg">
		...
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-body">
					<form id="form_user" method="post" action="reserveUser.htm" enctype="multpart/from-data">
						...
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							...
							<tr>
								<td>员工生日：</td>
								<td><input id="birthday" name="birthday" readonly="readonly"
							...
							<tr>
								...
								<td>&nbsp;&nbsp;</td>
								<td>员工爱好：</td>
								<td><input type="checkbox" id="hobby1" name="hobby"
							...
							<tr>
								<td>员工头像：</td>
								<td>
								    <img alt="" id="pics" src="" width="50px" height="50px" ><!-- 回显 -->
								    <input type="file" id="picFile" name="picFile"/><!-- 把选择文件传到后台 -->
									<input type="hidden" id="pic"/><!-- 如果没修改就把原来的名字带过去 -->
							</td>
							</tr>
	...
	function initEditUser(getSelection){
		...
		$('#hobby1').prop('checked',getSelection.hobby.indexOf("足球")!=-1);
		$('#hobby2').prop('checked',getSelection.hobby.indexOf("篮球")!=-1);
